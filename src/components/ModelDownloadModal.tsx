...
const ModelDownloadModal: React.FC<ModelDownloadModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-gray-800 rounded-2xl p-5 w-full max-w-sm shadow-2xl transform transition-all duration-300 ease-out max-h-[90vh] overflow-y-auto"
        style={{
